...
class offer(models.Model):
    ...
    extra_include = models.CharField(max_length=5000, null=True, blank=True)
    ...
    highlight1 = models.CharField(max_length=2000, null=True, blank=True)
    highlight2 = models.CharField(max_length=2000, null=True, blank=True)
    highlight3 = models.CharField(max_length=2000, null=True, blank=True)
    highlight4 = models.CharField(max_length=2000, null=True, blank=True)
    highlight5 = models.CharField(max_length=2000, null=True, blank=True)
